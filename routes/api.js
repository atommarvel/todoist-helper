...
function validateInputs(req, res, next) {
    ...
    if (req.query.projectIgnores) {
        res.locals.projectIgnores = req.query.projectIgnores
            .split(',')
    ...
    if (req.query.queueTopId) {
        res.locals.queueTopId = parseInt(req.query.queueTopId);
    } else {
...
router.get('/job/queueTop', validateInputs, async function (req, res, next) {
